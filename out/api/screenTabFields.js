...
var ScreenTabFields = /** @class */ (function () {
    function ScreenTabFields(client) {
        this.client = client;
    }
    ScreenTabFields.prototype.getAllScreenTabFields = function (params, callback) {
    ...
    ScreenTabFields.prototype.addScreenTabField = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
                    ...
                    method: 'POST',
                    data: {
                        fieldId: params === null || params === void 0 ? void 0 : params.fieldId,
                    },
                };
                return [2 /*return*/, this.client.sendRequest(request, callback)];
            });
    ...
    ScreenTabFields.prototype.removeScreenTabField = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
    ...
    ScreenTabFields.prototype.moveScreenTabField = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
