...
var ScreenSchemes = /** @class */ (function () {
    function ScreenSchemes(client) {
        this.client = client;
    }
    ScreenSchemes.prototype.getScreenSchemes = function (params, callback) {
        var _a;
    ...
    ScreenSchemes.prototype.createScreenScheme = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
                    ...
                    data: {
                        ...
                        screens: params === null || params === void 0 ? void 0 : params.screens,
                    },
                };
                return [2 /*return*/, this.client.sendRequest(request, callback)];
            });
    ...
    ScreenSchemes.prototype.deleteScreenScheme = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
