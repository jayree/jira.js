        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                request = {
                    ...
                    method: 'GET',
                    params: {
                        fieldName: params === null || params === void 0 ? void 0 : params.fieldName,
                        fieldValue: params === null || params === void 0 ? void 0 : params.fieldValue,
                        predicateName: params === null || params === void 0 ? void 0 : params.predicateName,
                        predicateValue: params === null || params === void 0 ? void 0 : params.predicateValue,
                    },
                };
                return [2 /*return*/, this.client.sendRequest(request, callback)];
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                request = {
                    ...
                    method: 'POST',
                    params: {
                        validation: params === null || params === void 0 ? void 0 : params.validation,
                    },
                    data: {
                        queries: params === null || params === void 0 ? void 0 : params.queries,
                    },
                };
                return [2 /*return*/, this.client.sendRequest(request, callback)];
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                request = {
                    ...
                    method: 'POST',
                    data: {
                        queryStrings: params === null || params === void 0 ? void 0 : params.queryStrings,
                    },
                };
                return [2 /*return*/, this.client.sendRequest(request, callback)];
            });
