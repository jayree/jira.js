...
var ScreenTabs = /** @class */ (function () {
    function ScreenTabs(client) {
        this.client = client;
    }
    ScreenTabs.prototype.getAllScreenTabs = function (params, callback) {
    ...
    ScreenTabs.prototype.createScreenTab = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
    ...
    ScreenTabs.prototype.updateScreenTab = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
    ...
    ScreenTabs.prototype.deleteScreenTab = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
    ...
    ScreenTabs.prototype.moveScreenTab = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = {
